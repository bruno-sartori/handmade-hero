...
inline void PushPiece(entity_visible_piece_group *Group, loaded_bitmap *Bitmap, v2 Offset, real32 OffsetZ, v2 Align, real32 Alpha = 1.0) {
  ...
  for(uint32 HighEntityIndex = 1; HighEntityIndex < GameState->HighEntityCount; ++HighEntityIndex) {
    ...
    switch (LowEntity->Type) {
      ...
      case EntityType_Monster: {
        ...
        PushPiece(&PieceGroup, &GameState->Shadow, V2(0, 0), 0, HeroBitmaps->Align, ShadowAlpha);
        PushPiece(&PieceGroup, &GameState->Monster, V2(0, 0), -20, V2(40, 80));
      } break;
